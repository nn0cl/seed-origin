...
- Alerts #1 and #2: fixed by path canonicalization.
- Alert #3: dismissed as false positive after reviewing the same canonicalization and filename allowlist boundary. GitHub CodeQL does not model this custom sanitizer.
