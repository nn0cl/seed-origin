...
| LISS-0153 | done | M | M | AIP-0153-001 | LISS-0152 | - | feature/liss-0152-client-side-prediction |
...
- Issue: **LISS-0128** reconnect remainder (timeout/ops/UI) — **in_progress**;
  I/O slice unblocked by LISS-0154 on this branch.
- Reason LISS-0153 is done: Adjudicator approved durable policy closure on
  2026-08-20; issue `review` → `done`. Early implementation already on branch;
  deferred items (collision-avoidance spawn, operator permission ADR, auth Phase 2
  NFC/case-insensitive) tracked outside LISS-0153 closure.
