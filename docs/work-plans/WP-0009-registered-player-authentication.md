...
| 1.3 | LISS-0156 | `seed_auth` MyBatis mapper 置換 + Spring Boot アップグレード | in_progress / phase-3-refactor（Boot **4.1.0** + MyBatis **4.1.0**；branch `feature/liss-0156-mybatis-boot-upgrade`） |
