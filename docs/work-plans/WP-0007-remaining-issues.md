...
| 8.1 | LISS-0143 | PostgreSQL IdentityAliasStoreアダプタ（ADR 0016） | in_progress |
| 8.2 | LISS-0144 | 管理者認証・エクスポート・衝突解決HTTP API（ADR 0017） | in_progress |
| 8.3 | LISS-0145 | 管理者UI（React SPA + SSE） | proposed（design intake） |
